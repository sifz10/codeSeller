...
@section('content')
  <!-- Content Scroll -->
  @php
    $usdProduct = DB::table('products')->where('currency', 'USD')->get();
  @endphp
              ...
              <div id="hero-styles">
                  <div id="hero-caption" class="reverse-parallax-onscroll">
                      <div class="inner">
                          ...
                          <div class="hero-subtitle">USD</div>
                      </div>
                  </div>
                  <div id="hero-footer">
                      ...
                      <div class="next-project-title">
                          <div class="inner">
                                  ...
                                  <div class="item disable-drag active">
                                      <div class="item-appear">
                                          <div class="item-content">
                                              <a class="item-wrap ajax-link-project" data-type="page-transition" href="{!! route('inrPlayCode') !!}"></a>
                                          ...
                                          <div class="item-caption">
                                              <h2 class="item-title">Play Card Code (INR)</h2>
                                          </div>
                                      </div>
                                  </div>
                            </div>
                              ...
                              <div class="marquee-wrapper">
                                  <div class="next-title-marquee" data-text="Play Card Code (INR) Play Card Code (INR)">Play Card Code (INR) Play Card Code (INR)</div>
                              </div>
                          </div>
                      </div>
